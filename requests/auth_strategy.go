// Package requests provides authentication strategies and shared HTTP request
// building/execution helpers used across the Yoti Go SDK's clients.
package requests
...
// The endpoint may already contain its own query string (e.g. business
// parameters unrelated to auth); the strategy's params are appended to it.
