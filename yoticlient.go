...
// GetUserProfile requests information about a Yoti user using the one time
// use token generated by the Yoti login process.
// It returns the outcome of the request. If the request was successful it will
// include the users details, otherwise it will specify a reason the request failed.
