...
// GetActivityDetails requests information about a Yoti user using the one time use token generated by the Yoti login process.
 // It returns the outcome of the request. If the request was successful it will include the user's details, otherwise
// an error will be returned, which will specify the reason the request failed.
// If the function call can be reattempted with the same token the error will
// be a temporary error.
